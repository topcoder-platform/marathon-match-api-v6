...
- Downloaded tester JARs and serialized scorer config are mode `0400` root-owned files. Submitted code running as `scorer` cannot read or modify them even if it can guess their `/tmp` paths.
