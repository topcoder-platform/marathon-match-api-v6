...
async function bootstrap() {
  ...
  // Global prefix for all routes to keep endpoint contracts consistent.
  app.setGlobalPrefix(API_PREFIX);
  logger.log(`Setting global prefix to ${API_PREFIX}`);
  ...
  const config = new DocumentBuilder()
    .setTitle('Topcoder Marathon Match API')
    .setDescription(
      `
    Topcoder Marathon Match API Documentation
    ...
    - Available scopes: create:marathon-match, read:marathon-match, update:marathon-match, delete:marathon-match, all:marathon-match, create:marathon-match-tester, read:marathon-match-tester, update:marathon-match-tester, delete:marathon-match-tester, all:marathon-match-tester
