...
export class MarathonMatchConfigService {
   ...
   * Uses the challenge's currently open phase config, validates active/open challenge
   * runtime state through challenge-api, and reduces submission API results to one latest
   * submission per member before delegating ECS orchestration to `EcsService`.
