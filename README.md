...
| `DEFAULT_SYSTEM_TEST_TIMEOUT_MS`   | No                    | `86400000`                                                                  | Default total SYSTEM scoring timeout returned by `GET /challenge/defaults`                                 |
...
- `POST /v6/marathon-match/internal/scoring-progress`
